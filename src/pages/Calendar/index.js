                            ...
                            <AvForm onValidSubmit={this.handleValidEventSubmit}>
                              <Row form>
                                ...
                                <Col className="col-12 mb-3">
                                  ...
                                  >
                                      <option value="bg-danger">Sport</option>
                                      <option value="bg-success">Innovation</option>
                                      <option value="bg-primary">Walkathon</option>
                                      <option value="bg-info">Hackathon</option>
                                      <option value="bg-dark">Indoor Games</option>
                                      <option value="bg-warning">Others</option>
                                  </AvField>
                                </Col>
                              </Row>
                              <Row>
